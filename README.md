...
- **🤖 AI Menu Parsing** – Snap a photo of a menu or poster; Google **Gemini AI** extracts venues, items, prices, and time windows.  
...
https://drive.google.com/file/d/1XkuNGqqg6zEVLzDwxyK_crg07OwFHXdG/view?usp=drive_link

**ios version coming soon...**

### 1. Clone the Repository
```bash
git clone https://github.com/yourusername/happymapper.git
cd happymapper
